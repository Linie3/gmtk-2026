...
var resource_container: PackedScene = preload("res://ui/resource_container.tscn")
var resource_containers: Dictionary[GameResource.ResourceType, Control] = {}
var item_slot: PackedScene = preload("res://ui/item_slot.tscn")
...
func _ready() -> void:
	...
	if Global.instruction_page:
		Global.instruction_page = false
